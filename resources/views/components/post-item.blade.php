<article class="bg-white    flex flex-col shadow my-4">
    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        <p href="#" class="text-sm pb-3">
            By <a href="#" class="font-semibold hover:text-gray-800">{{$post->user->name}}</a>, Опубликовано
        ...
        <a  href="{{route('view', $post)}}" class="uppercase text-gray-800 hover:text-black">Читать <i
